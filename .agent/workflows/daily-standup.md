...
2. Create an **Artifact** named `step5_standup_summary.md`:
   ...
   ✅ **Progress**: Strong progress on Sprint XX. X stories completed yesterday, X actively in progress. All tests passing.
...
- ❌ **Do not invent**: Only use real commits, tickets, and test results.
- 🔒 **Do not expose secrets**: No API keys, passwords, or sensitive URLs.
- ⏱️ **Keep it short**: Summary should be readable in 2 minutes max.
- 👤 **Human approves**: Never share the summary without explicit user approval.
- 📅 **Daily cadence**: Run this workflow each morning (e.g., 8:30 AM before standup at 9:00 AM).
...
- ✅ All artifacts are generated and presented to user.
